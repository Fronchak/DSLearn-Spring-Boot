package com.fronchak.DSLearn.exceptions.handler;
...
public class CustomizeResponseEntityExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleResourceNotFoundException(
		...
		ExceptionResponse response = makeResponse(new ExceptionResponse(), e, request, status, ResourceNotFoundException.getError());
	...
	public ResponseEntity<ExceptionResponse> handleMethodArgumentNotValidException(
		...
		ValidationExceptionResponse response = 
				(ValidationExceptionResponse) makeResponse(new ValidationExceptionResponse(), e, request, status, "Validation Exception");
